...
function generateFooter() {
  const footerContainer = document.getElementById("footer_container");
    ...
    const footerHTML = `
        <div
          class="d-flex w-100 w-sm-25 align-items-center justify-content-center justify-content-sm-start">
          <span class="white-font">© 2024 Rosemary Boards, Inc</span>
        </div>

        <div
          class="d-flex flex-row w-100 w-sm-25 mr-3 align-items-center justify-content-center mt-3 mt-sm-0 justify-content-sm-end">
